...
Runtime plugin that connects agents to [Salesforce](https://www.salesforce.com) through [Salesforce Hosted MCP](https://developer.salesforce.com/docs/platform/hosted-mcp-servers/), Salesforce's first-party [Model Context Protocol](https://modelcontextprotocol.io/) service.
...
Add every callback URL you need — Runtime uses different ones per surface:

| Surface | Callback URL |
|:--------|:-------------|
| Desktop | `http://localhost:8787/callback` |
| Web and Cloud Agents | `https://www.lemonsquared.com/agents/mcp/oauth/callback` |
...
In **Dashboard → Plugins → Configure**, set **Salesforce MCP server URL** and **Salesforce Consumer Key**, then complete the Salesforce login when Runtime prompts.
...
- Configure Runtime: https://developer.salesforce.com/docs/platform/hosted-mcp-servers/guide/cursor.html
