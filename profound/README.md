...
Runtime plugin that connects agents to [Profound](https://www.tryprofound.com) through Profound's official hosted [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth 2.1 against Profound. Runtime prompts for Profound sign-in when the plugin connects — there is no API key or client ID to configure.
