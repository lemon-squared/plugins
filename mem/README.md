...
Runtime plugin that connects agents to [Mem](https://mem.ai) through Mem's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth. Runtime prompts for Mem sign-in when the plugin connects.
