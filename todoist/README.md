...
Runtime plugin that connects agents to [Todoist](https://www.todoist.com) through Todoist's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth. Runtime prompts for Todoist sign-in on the first tool call — there is no API key to configure.
