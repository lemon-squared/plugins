...
Runtime plugin that connects agents to [GoDaddy](https://www.godaddy.com) through GoDaddy's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
