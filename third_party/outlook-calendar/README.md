...
Runtime plugin that connects agents to [Outlook Calendar](https://outlook.com/calendar) through Runtime's remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
```json
{
  "mcpServers": {
    "outlook-calendar": {
      "type": "http",
      "url": "https://api.lemonsquared.com/rest-mcp/outlook-calendar/mcp"
    }
  }
}
```
