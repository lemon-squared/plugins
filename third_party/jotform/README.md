...
Runtime plugin that connects agents to [Jotform](https://www.jotform.com) through Jotform's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth 2.0 and it is required on first connect. Runtime prompts for Jotform sign-in when the plugin connects. Bearer-token access is not supported.
