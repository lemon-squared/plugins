...
Runtime plugin that connects agents to [Craft](https://www.craft.do) through Craft's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth. Runtime prompts for Craft sign-in when the plugin connects, and you pick which space to grant access to on the authorization screen.
...
- Connect Craft to Runtime: https://www.craft.do/imagine/guide/mcp/cursor
