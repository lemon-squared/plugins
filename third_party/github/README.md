...
Runtime plugin that connects agents to [GitHub](https://github.com) through GitHub's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Logo is GitHub's official Octocat mark, placed on a white tile with padding so it reads well in the Runtime UI.
