...
Runtime plugin that connects agents to [Fireflies](https://fireflies.ai) through Fireflies's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth against your Fireflies, Google, or Microsoft account. Runtime prompts for sign-in when the plugin connects.
