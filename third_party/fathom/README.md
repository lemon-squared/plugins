...
Runtime plugin that connects agents to [Fathom](https://fathom.video) through Fathom's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth. Runtime prompts for Fathom sign-in when the plugin connects.
