...
Runtime plugin that connects agents to [Readwise](https://readwise.io) through Readwise's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth. Runtime prompts for Readwise sign-in when the plugin connects — there is no API key to configure.
