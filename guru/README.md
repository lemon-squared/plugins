...
Runtime plugin that connects agents to [Guru](https://www.getguru.com) through Guru's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
Auth is OAuth 2.0. Runtime prompts for Guru sign-in when the plugin connects.
