...
- Prefer person chat for coaching; use Teach a task on the person-computer when a skill needs a live demo.
- Persist durable learner prefs with account/person memory (profile/log).
