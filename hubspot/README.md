...
Runtime plugin that connects agents to [HubSpot](https://www.hubspot.com) through HubSpot's official remote [Model Context Protocol](https://modelcontextprotocol.io/) server.
...
4. Complete the HubSpot OAuth login when Runtime prompts. Select the account to connect and grant permissions.
